local Aether = loadstring(game:HttpGet("https://raw.githubusercontent.com/hoctienganhcungtruong/Aether/main/v6.lua", true))()

-- Window sizes are configured and loaded STRICTLY by code here:
local Menu = Aether.new("Aether Utility Engine", Vector2.new(580, 440))
...
Players.PlayerRemoving:Connect(function(plr) HighLightStorage[plr] = nil end)
...
-- Infinite Yield Loadstring Injection
