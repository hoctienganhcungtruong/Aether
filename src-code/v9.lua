--[[
    Aether UI Library - Version 5 (With Programmatic Resize)
--]]
...
-- DIRECTIONAL RESIZE ENGINE
local function makeResizable(resizeHandle, targetFrame, minSize, axis)
...
function Aether.new(titleText, initialSize, minSize)
    ...
    RightEdge.Name = "RightEdgeSensor"
    RightEdge.Size = UDim2.new(0, 6, 1, -42)
    RightEdge.Position = UDim2.new(1, -6, 0, 36)
    RightEdge.BackgroundTransparency = 1
    RightEdge.Active = true
    RightEdge.ZIndex = 10
    RightEdge.Parent = MainFrame
    makeResizable(RightEdge, MainFrame, minSize, "X")
    
    local BottomEdge = Instance.new("Frame")
    BottomEdge.Name = "BottomEdgeSensor"
    BottomEdge.Size = UDim2.new(1, -166, 0, 6)
    BottomEdge.Position = UDim2.new(0, 160, 1, -6)
    BottomEdge.BackgroundTransparency = 1
    BottomEdge.Active = true
    BottomEdge.ZIndex = 10
    BottomEdge.Parent = MainFrame
    makeResizable(BottomEdge, MainFrame, minSize, "Y")
    
    local CornerGrip = Instance.new("Frame")
    CornerGrip.Name = "CornerGripSensor"
    CornerGrip.Size = UDim2.new(0, 12, 0, 12)
    CornerGrip.Position = UDim2.new(1, -12, 1, -12)
    CornerGrip.BackgroundTransparency = 1
    CornerGrip.Active = true
    CornerGrip.ZIndex = 11
    CornerGrip.Parent = MainFrame
    ...
    CornerIcon.Parent = CornerGrip
    makeResizable(CornerGrip, MainFrame, minSize, "Both")
    ----------------------------------------------------------------------------
