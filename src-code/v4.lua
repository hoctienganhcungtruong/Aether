--[[
    Aether UI Library - Version 4
    Fixes: No-interference edge scrolling, customizable initial/minimum window bounds.
--]]
...
-- Updated Window Creator supporting custom default & minimum sizes
function Aether.new(titleText, initialSize, minSize)
    ...
    -- Page Container (Offset dynamically from the bottom to never overlap resize grip)
    local PageContainer = Instance.new("Frame")
    PageContainer.Size = UDim2.new(1, -160, 1, -51) -- Subtracted 15 extra pixels on Y axis
    PageContainer.Position = UDim2.new(0, 160, 0, 36)
    PageContainer.BackgroundTransparency = 1
    PageContainer.Parent = MainFrame
    
    -- Isolated Resize Grip Frame (In the absolute bottom right corner)
    ...
    CornerGripVisual.Image = "rbxassetid://6031093149"
    CornerGripVisual.ImageColor3 = Theme.TextMuted
    CornerGripVisual.Parent = ResizeGrip
    
    makeResizable(ResizeGrip, MainFrame, minSize)
...
function Aether:AddTab(tabName)
    ...
    -- Scrolling frame is isolated inside PageContainer, leaving a safety gap on the right
    local Page = Instance.new("ScrollingFrame")
    Page.Size = UDim2.new(1, -8, 1, 0) -- leaves space on right so scrollbar/grip don't conflict
    ...
    -- Advanced Saturation-Value Color Picker
