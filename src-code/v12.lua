...
function Aether.new(titleText, initialSize, minSize)
    ...
    OpenIcon.Name = "AetherOpenIcon"
    OpenIcon.Size = UDim2.new(0, 48, 0, 48)
    OpenIcon.Position = UDim2.new(0.03, 0, 0.15, 0)
    OpenIcon.BackgroundColor3 = Theme.SidebarBg
    OpenIcon.Text = "A"
    OpenIcon.TextColor3 = Theme.Text
    ...
    IconGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 24, 50)),
    ...
    HideButton.Position = UDim2.new(1, -31, 0.5, -13)
    HideButton.BackgroundTransparency = 1
    HideButton.Text = "×"
    HideButton.TextColor3 = Theme.TextMuted
    HideButton.TextSize = 14
    HideButton.Font = Enum.Font.GothamBold
    HideButton.ZIndex = 16
    ...
    OpenIcon.MouseEnter:Connect(function()
        tween(IconStroke, TweenInfo.new(0.2), {Color = Theme.AccentHover})
        tween(OpenIcon, TweenInfo.new(0.2), {Size = UDim2.new(0, 52, 0, 52)})
    end)

    OpenIcon.MouseLeave:Connect(function()
        tween(IconStroke, TweenInfo.new(0.2), {Color = Theme.Accent})
        tween(OpenIcon, TweenInfo.new(0.2), {Size = UDim2.new(0, 48, 0, 48)})
    end)
    ...
    HideButton.MouseButton1Click:Connect(function()
        ...
        tween(OpenIcon, TweenInfo.new(0.25, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
    ...
    OpenIcon.MouseButton1Click:Connect(function()
        ...
        tween(MainFrame, TweenInfo.new(0.25, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
            Size = UDim2.new(0, MainFrame.Size.X.Offset, 0, self.OriginalHeight)
        })
    end)
    ...
    RightDragEdge.Size = UDim2.new(0, 6, 1, -36)
...
function Aether:AddTab(tabName)
    ...
    function Tab:AddLabel(text, tag)
        ...
        local tagStyles = {
            ...
            b  = {size = 13, font = Enum.Font.GothamBold, color = Theme.Text, height = 18},
            i  = {size = 13, font = Enum.Font.GothamItalic, color = Theme.TextMuted, height = 18},
            s  = {size = 13, font = Enum.Font.Gotham, color = Theme.TextMuted, height = 18}
        }
    ...
    function Tab:AddDropdown(text, options, default, callback)
        ...
        SelectedLabel.Text = tostring(selectedOption)
        ...
        local function refreshOptions()
            ...
            for _, opt in ipairs(options) do
                ...
                OptBtn.BackgroundColor3 = (opt == selectedOption) and Theme.SidebarBg or Color3.fromRGB(22, 18, 34)
                OptBtn.Text = ""
                ...
                RadioCircle.Size = UDim2.new(0, 14, 0, 14)
                RadioCircle.Position = UDim2.new(0, 10, 0.5, -7)
                RadioCircle.BackgroundColor3 = Color3.fromRGB(40, 32, 60)
                RadioCircle.Parent = OptBtn

                local RadioCorner = Instance.new("UICorner")
                RadioCorner.CornerRadius = UDim.new(1, 0)
                RadioCorner.Parent = RadioCircle

                local RadioDot = Instance.new("Frame")
                RadioDot.Size = UDim2.new(0, 8, 0, 8)
                RadioDot.Position = UDim2.new(0.5, -4, 0.5, -4)
                RadioDot.BackgroundColor3 = Theme.Accent
                RadioDot.Visible = (opt == selectedOption)
                RadioDot.Parent = RadioCircle

                local RadioDotCorner = Instance.new("UICorner")
                RadioDotCorner.CornerRadius = UDim.new(1, 0)
                RadioDotCorner.Parent = RadioDot

                local OptText = Instance.new("TextLabel")
                OptText.Size = UDim2.new(1, -35, 1, 0)
                OptText.Position = UDim2.new(0, 30, 0, 0)
                OptText.BackgroundTransparency = 1
                OptText.Text = tostring(opt)
                OptText.TextColor3 = (opt == selectedOption) and Theme.Text or Theme.TextMuted
                OptText.TextSize = 12
        ...
        Header.MouseButton1Click:Connect(function()
            ...
            local targetFrameHeight = isOpened and (ContentLayout.AbsoluteContentSize.Y + 50) or 42

            tween(Content, TweenInfo.new(0.2), {Size = UDim2.new(1, -20, 0, targetContentHeight)})
            tween(DropdownFrame, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, targetFrameHeight)})
    ...
    function Tab:AddKeybind(text, defaultKey, callback)
        ...
        KeybindFrame.BackgroundColor3 = Theme.ContainerBg
        ...
        BindBtn.Position = UDim2.new(1, -105, 0.5, -13)
        BindBtn.BackgroundColor3 = Color3.fromRGB(22, 18, 32)
